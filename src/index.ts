...
const handlers = [
    ...
    new ProxyHandler(new RegExp(MY_PREFIX +"/bbmStatusForBbmAlsoPinkEraAndLillieAreCuteBtwWilliamGay$"),      REMOTE_SERVER + "/bbmStatusForBbmAlsoPinkEraAndLillieAreCuteBtwWilliamGay")
                                                                                                                                                .with_cache(60 * 5),
    new ProxyHandler(new RegExp(MY_PREFIX +"/status$"),                    REMOTE_SERVER + "/status")                                           .with_cache(60 /* seconds */ * 5 /* minutes */),
    ...
    new ProxyHandler(new RegExp(MY_PREFIX +"/hashlookup(.*)$"),            REMOTE_SERVER + "/hashlookup$1")                                     .with_cache(),
    ...
    new ProxyHandler(new RegExp(MY_PREFIX +"/versions(.*)$"),              REMOTE_SERVER + "/versions$1")                                       .with_cache(),
